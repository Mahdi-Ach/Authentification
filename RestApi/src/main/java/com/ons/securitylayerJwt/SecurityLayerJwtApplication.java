...
public class SecurityLayerJwtApplication {
    ...
    {return  args ->
    {
        ...
        Role role1 = iRoleRepository.findByRoleName(RoleName.USER);
        Role role2 = iRoleRepository.findByRoleName(RoleName.SUPERADMIN);
        ...
        userr.getRoles().add(role1);
        userr.getRoles().add(role2);
